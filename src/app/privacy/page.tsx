...
export const metadata = {
  ...
  description:
    "Privacy policy for CircuitSnips, the open-source KiCad circuit sharing platform",
};
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              CircuitSnips (&quot;we&quot;, &quot;our&quot;, or &quot;us&quot;)
              is committed to protecting your privacy. This Privacy Policy
              explains how we collect, use, and safeguard your information when
              you use our open-source platform for sharing KiCad schematic
              subcircuits.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              <strong>Note:</strong> Vercel Analytics is privacy-friendly and
          ...
          <section className="mb-8">
            ...
            <p>
              CircuitSnips uses only <strong>essential cookies</strong>{" "}
              necessary for authentication and platform functionality:
            </p>
            <ul className="list-disc pl-6 mb-4">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                <strong>Vercel:</strong> Hosting infrastructure with HTTPS
                encryption
              </li>
              <li>
                <strong>GitHub:</strong> OAuth authentication (no passwords
                stored)
              </li>
            </ul>
            <p>
              All data transmission is encrypted using TLS/SSL. We implement
              industry-standard security measures including rate limiting, input
          ...
          <section className="mb-8">
            ...
            <p>
              All circuits you upload are <strong>public by default</strong> and
              visible to all users. When you upload a circuit, you agree to
              share it under the open-source license you select (e.g., MIT,
              CERN-OHL-S-2.0).
            </p>
            <p>
              Your profile information (username, avatar, bio, website) is also
              public.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                <strong>Export:</strong> Download your uploaded circuits and
                data
              </li>
            </ul>
            <p>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              ...
              <li>
                Your uploaded circuits and comments are removed from the
                platform
              </li>
          ...
          <section className="mb-8">
            ...
            <p>
              CircuitSnips is not intended for users under 13 years of age. We
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Continued use of CircuitSnips after changes constitutes acceptance
          ...
          <section className="mb-8">
            ...
            <ul className="list-none pl-0 mt-4">
              <li>
                <strong>Email:</strong> privacy@circuitsnips.com
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6">
              <li>
                <strong>Legal Basis:</strong> Consent (account creation) and
                legitimate interest (platform operation)
              </li>
              <li>
                <strong>Data Controller:</strong> CircuitSnips
              </li>
              <li>
                <strong>Data Processor:</strong> Supabase (data hosting)
              </li>
              <li>
            ...
            <p>
              To exercise your GDPR rights, contact us at the email address
              above.
            </p>
          </section>
        </div>
