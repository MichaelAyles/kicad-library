...
export const metadata = {
  ...
  description:
    "Terms of Service for CircuitSnips, the open-source KiCad circuit sharing platform",
};
      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              By accessing or using CircuitSnips ("the Service"), you agree to
              be bound by these Terms of Service ("Terms"). If you do not agree
              to these Terms, please do not use the Service.
            </p>
            <p>
              CircuitSnips is an open-source platform for sharing KiCad
              schematic subcircuits. The platform itself is licensed under the
              MIT License.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              To upload circuits and participate in the community, you must
              create an account using GitHub OAuth. You are responsible for:
            </p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">
              3. User Content and Licensing
            </h2>

            <h3 className="text-xl font-semibold mb-3">3.1 Your Content</h3>
            <p>
              When you upload circuits to CircuitSnips, you retain all ownership
              rights to your content. However, you must choose an open-source
              hardware license for each circuit you upload.
            </p>

            <h3 className="text-xl font-semibold mb-3">
              3.2 Supported Licenses
            </h3>
            ...
            <p>
              By uploading a circuit, you grant all users the right to use,
              copy, modify, and distribute your circuit under the terms of the
              license you selected. This grant is irrevocable.
            </p>

            <h3 className="text-xl font-semibold mb-3">3.4 Attribution</h3>
            <p>
              CircuitSnips automatically embeds attribution information (author,
              license, source URL) into downloaded circuits. Users who download
              your circuits must provide proper attribution as required by the
              license you selected.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              The CircuitSnips platform itself is open-source software licensed
              under the MIT License. You may view, fork, and contribute to the
              source code on GitHub.
            </p>

            <h3 className="text-xl font-semibold mb-3">5.2 User Circuits</h3>
            <p>
              Each circuit uploaded to CircuitSnips is licensed under the
              specific open-source license chosen by its author. Check each
              circuit's license before using it in your projects.
            </p>

            <h3 className="text-xl font-semibold mb-3">5.3 Trademarks</h3>
            <p>
              "CircuitSnips" and the CircuitSnips logo are trademarks. "KiCad"
              is a trademark of the KiCad project. All trademarks belong to
          ...
          <section className="mb-8">
            ...
            <p>
              We will make reasonable efforts to notify you before removing
              content, except in cases of clear legal violations.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              <strong>USE CIRCUITS AT YOUR OWN RISK.</strong> Always verify and
              test circuits before using them in production designs, especially
          ...
          <section className="mb-8">
            ...
            <p>OUR TOTAL LIABILITY SHALL NOT EXCEED $100 USD.</p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              CircuitSnips infringes your copyright, please contact us with:
            </p>
            <ul className="list-disc pl-6 mb-4">
          ...
          <section className="mb-8">
            ...
            <p>
              For significant changes, we will provide notice via email or a
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              platform is operated, without regard to conflict of law
              principles.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-none pl-0 mt-4">
              <li>
                <strong>Email:</strong> legal@circuitsnips.com
              </li>
              <li>
                ...
                >
                  github.com/MichaelAyles/kicad-library
                </a>
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8 bg-muted/30 p-6 rounded-lg">
            ...
            <p>
              CircuitSnips is open-source software. The platform code is
